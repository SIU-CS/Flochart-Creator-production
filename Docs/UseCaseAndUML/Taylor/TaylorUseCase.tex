...
\subsection{Diagram}
See \underline{\hyperref[fig:use-case-1]{Figure 1}} below.
% Line breaks so the diagram appears after the diagram subsection rather than at the top of the next page after part of Use Case 2.
\newline
\newline
\newline
\newline
